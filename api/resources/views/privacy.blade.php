...
<div class="container">
    ...
    <p class="muted">Questa informativa descrive come trattiamo i tuoi dati personali quando
        utilizzi {{ config('app.name') }}.</p>
    ...
    <ul>
        ...
        <li><strong>Impostazioni notifiche</strong>: preferenze su email e push (<span
                class="kbd">notify_by_email</span>, <span class="kbd">notify_by_push</span>).
        </li>
        <li><strong>Token push</strong>: identificatori del dispositivo per l'invio di notifiche (Expo Push Token).</li>
        <li><strong>Dati di utilizzo</strong>: prodotti, scadenze, note, categoria del prodotto, e altre preferenze
            salvate.
        </li>
    ...
    <ul>
        ...
        <li><strong>Obbligo legale</strong> e <strong>legittimo interesse</strong>: sicurezza, prevenzione frodi,
            gestione log.
        </li>
    </ul>
    ...
    <ul>
        ...
        <li>Non vendiamo i tuoi dati. Condividiamo solo quanto necessario per erogare il servizio o rispettare la
            legge.
        </li>
    </ul>

    <h2>7. Trasferimenti extra-UE</h2>
    <p>Alcuni fornitori possono trovarsi fuori dall'UE/SEE. In tal caso, adottiamo garanzie adeguate (es. clausole
        contrattuali tipo) ove richieste.</p>

    <h2>8. Sicurezza</h2>
    <p>Adottiamo misure organizzative e tecniche ragionevoli per proteggere i dati. Nessuna misura è però assoluta:
        conserva le tue credenziali con cura.</p>

    <h2>9. I tuoi diritti</h2>
    <ul>
        <li>Accesso, rettifica, cancellazione, limitazione, opposizione, portabilità dei dati (ove applicabile).</li>
        <li>Puoi eliminare l'account dall'app (Profilo → "Elimina account") o seguendo <a
                href="{{ url('/elimina-account') }}">questa procedura</a>.
        </li>
        <li>Puoi modificare le preferenze di notifica dal profilo.</li>
    </ul>

    <h2>10. Minori</h2>
    <p>Il servizio non è destinato a minori di 14 anni. Se credi che un minore ci abbia fornito dati, contattaci per la
        rimozione.</p>

    <h2>11. Modifiche a questa informativa</h2>
    <p>Potremmo aggiornare questa informativa. Pubblicheremo la versione aggiornata su questa pagina con l'indicazione
        della data.</p>
